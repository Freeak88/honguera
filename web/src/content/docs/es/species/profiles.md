---
title: Perfiles de Especie
description: Parámetros de cultivo por especie — cada una un firmware biológico distinto.
---
...
1. Crear archivo JSON en `docs/species/` con nombre de la especie
2. Incluir las 3 fases con targets
3. Documentar la fuente de los parámetros (paper, experiencia propia, referencia)
4. PR al repo
